...
import Login from "./pages/authService/Login.tsx";
import Register from "./pages/authService/Register.tsx";
    ...
    <Layout style={{width: '100vw', height: '100vh'}}>
      <Sider trigger={null} collapsible collapsed={collapsed}>
        ...
        <Menu
          ...
          items={
            [
              {key: '10', icon: <HomeOutlined/>, label: <NavLink to="/index">主页</NavLink>},
              {key: '20', label: '用户服务', icon: <UserOutlined/>, children:
                  [
                    {key: '21', label: <NavLink to="/userService/user">用户管理</NavLink>, icon: <UserAddOutlined/>},
                    {
                      key: '22',
                      label: <NavLink to="/userService/organization">组织管理</NavLink>,
                      icon: <UsergroupAddOutlined/>
                    },
                    {key: '23', label: <NavLink to="/userService/role">角色管理</NavLink>, icon: <UserSwitchOutlined/>},
                    {
                      key: '24',
              ...
              {key: '30', label: '身份验证服务', icon: <LoginOutlined />, children:
                [
                  {key: '31', icon: <HomeOutlined/>, label: <NavLink to="/authService/login">登录</NavLink>},
                  {key: '32', icon: <HomeOutlined/>, label: <NavLink to="/authService/register">注册</NavLink>}
                ]
              }
            ]
          }
      ...
      <Layout>
        ...
        <Content style={{
          ...
          <Routes>
            ...
            <Route path="/authService/login" element={<Login/>}/>
            <Route path="/authService/register" element={<Register/>}/>
          </Routes>
        </Content>
